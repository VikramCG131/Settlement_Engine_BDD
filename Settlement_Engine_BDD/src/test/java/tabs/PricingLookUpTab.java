...
//		} 
	...
	public void enterBMCategoryFieldValue(String currency, String clientcode, String productCode,
			String instalments, String offerMonths, String loanAmountMin, String loanAmountMax, String rule,
	...
	public void verifyBMSuccessPopupMessage() throws InterruptedException  {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(PricingLookUpLocators.PLSuccesspopupMessageUploadOk)).click();
	}
	...
	public void clickBMUpdateButton() {
		wait.until(ExpectedConditions.visibilityOfElementLocated(PricingLookUpLocators.PLUpdateButton));
		driver.findElement(PricingLookUpLocators.PLUpdateButton).click();
	...
	public void verifyAllFieldsClearedforResetButton() {
		...
		String thirdParty1Encoding = driver.findElement(PricingLookUpLocators.PLThirdParty1Encoding).getAttribute("value");
		String thirdParty1Rate = driver.findElement(PricingLookUpLocators.PLThirdParty1Rate).getAttribute("value");
		String thirdParty2Encoding = driver.findElement(PricingLookUpLocators.PLThirdParty2Encoding).getAttribute("value");
		String thirdParty2Rate = driver.findElement(PricingLookUpLocators.PLThirdParty2Rate).getAttribute("value");
		String thirdParty3Encoding = driver.findElement(PricingLookUpLocators.PLThirdParty3Encoding).getAttribute("value");
...
// 	//Verify the Data Quality Assignment Grid is Visible and Data Assignment Category is Not Visible
	...
	//Verify Success message of Upload
	 public void verifyUploadSuccessMessage() {
	    	String actual = wait.until(ExpectedConditions.visibilityOfElementLocated(PricingLookUpLocators.PLSuccesspopupMessageUpload)).getText();
	...
	//Click on Send for Approval button
	 ...
	 //Verify submission of file for approval
	    ...
	    public void ConfirmationMessageConfirmAndCancelButtons() {
	    	 WebElement confirmButton = wait.until(ExpectedConditions.visibilityOfElementLocated(PricingLookUpLocators.PLDeleteConfirmationPopupConfirmButton));
	    	 WebElement cancelButton = wait.until(ExpectedConditions.visibilityOfElementLocated(PricingLookUpLocators.PLDeleteConfirmationPopupCancelButton));
