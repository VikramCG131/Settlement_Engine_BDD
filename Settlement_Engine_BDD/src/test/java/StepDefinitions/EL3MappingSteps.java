...
public class EL3MappingSteps {
    ...
    public void the_user_should_see_validation_errors_for_required_fields_for_the_EL3_mapping() throws InterruptedException {
    ...
    public void add_new_pop_up_should_be_closed_for_the_EL3_Mapping() throws InterruptedException {
    ...
    public void the_file_should_be_removed_from_the_table_for_the_EL3_Mapping() throws InterruptedException {
    	driver.findElement(By.xpath("//div[@data-ref='rootWrapperBody']")).isDisplayed();
		driver.quit();
		Thread.sleep(2000);
    }
