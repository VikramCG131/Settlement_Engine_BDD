...
public class BrandMappingSteps {
	 WebDriver driver;
		...
		public void the_user_click_on_the_brand_mapping() throws InterruptedException {
			driver.findElement(By.xpath("//span[contains(text(),'Brand Mapping')]")).click();
			Thread.sleep(3000);
			System.out.println("The user is able to navigate to Brand Mapping page");
			commonUtilities.screenshot();
		}
		...
		public void the_user_enters_the_data_in_required_fields_for_the_brand_mapping() {
			...
			driver.findElement(By.xpath("//input[@formcontrolname='clientCode']")).sendKeys("500" + random);
			driver.findElement(By.xpath("//input[@formcontrolname='brandCode']")).sendKeys("12" + random);
		}

		@When("the user should see click on the Submit Button for the Brand Mapping")
		public void the_user_should_see_click_on_the_submit_button_for_the_brand_mapping() throws InterruptedException {
		...
		public void the_user_click_on_reset_button_for_the_brand_mapping() throws InterruptedException {
	...
	public void the_user_update_the_any_field_for_the_brand_mapping() {
		driver.findElement(By.xpath("//input[@formcontrolname='clientCode']")).clear();
		driver.findElement(By.xpath("//input[@formcontrolname='clientCode']")).sendKeys("0.5");
	}

	@Then("the user should see click on the Update Button for the Brand Mapping")
	public void the_user_should_see_click_on_the_update_button_for_the_brand_mapping() throws InterruptedException {
	...
	public void the_user_should_see_a_confirmation_pop_up_with_title_for_the_brand_mapping(String string) throws InterruptedException {
	...
	public void the_user_should_see_message_for_the_brand_mapping(String string) throws InterruptedException {
		String actual = driver.findElement(By.xpath("//div[contains(text(),'Are you sure you want to delete')]")).getText();
	...
	public void the_user_should_see_a_confirmation_pop_up_with_cancel_and_confirm_buttons_for_the_brand_mapping() throws InterruptedException {
    ...
    public void user_click_the_send_for_approval_button() throws InterruptedException {
    	this.the_user_click_on_the_brand_mapping();
