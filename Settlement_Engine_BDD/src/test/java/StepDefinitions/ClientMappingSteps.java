...
public class ClientMappingSteps {
	 ...
	 WebDriver driver;
	    ...
	    @When("clicks on the Expand button for the left panel for client mapping")
	    ...
	    @Then("the User should see the Left panel expanded for the Client Mapping")
	    ...
	    @Then("the Menu Items should be visible for the Client Mapping")
	    ...
	    public void the_user_click_on_the_client_mapping() throws InterruptedException {
	        driver.findElement(By.xpath("//span[text()='Client Mapping']")).click();
	        Thread.sleep(3000);
	    ...
	    public void the_user_enters_the_data_in_required_fields_for_the_client_mapping() {
	        ...
	        driver.findElement(By.xpath("//input[@formcontrolname='shopCode']")).sendKeys("0.5");
	        driver.findElement(By.xpath("//input[@formcontrolname='mappedCode']")).sendKeys("Shop" + random);
	    ...
	    public void the_user_update_the_any_field_for_the_client_look_up() {
	    	driver.findElement(By.xpath("//input[@formcontrolname='shopCode']")).clear();
			driver.findElement(By.xpath("//input[@formcontrolname='shopCode']")).sendKeys("0.5");
	    }
