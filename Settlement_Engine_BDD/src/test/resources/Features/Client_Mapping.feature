Feature: Validation of the Client Mapping Reference LookUp UI Screen
   ...
   Background:  the user navigate to the Settlement Engine page
    ...
    And clicks on the Expand button for the left panel for client mapping
      Then the User is able to navigate to the Settlement Engine Homepage for the Client Mapping
      And the User should see the Left panel expanded for the Client Mapping
    And the Menu Items should be visible for the Client Mapping
...
Scenario: User downloads a file successfully
  When the user click on the Client Mapping
  And user clicks the download button for the Client Mapping page
