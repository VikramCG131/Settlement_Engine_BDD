...
#  When the user click on SE Group Config
 ...
 # Scenario: Submit form without entering group name
 # When the user click on SE Group Config
  # And the user clicks the Add button for the SE Group Config
  #  When User leave the Group Name field empty
  #  And User click the Submit button
   # Then User should see an error message Please Enter Group Name
