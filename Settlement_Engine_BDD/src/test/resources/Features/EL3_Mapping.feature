...
Scenario: Verify file Upload functionality 
  When the user click on the EL3 Mapping
  And the User Navigates to upload Button EL3 Mapping
  And user selects a valid file to upload EL3 Mapping
  And the file should be successfully uploaded EL3 Mapping
